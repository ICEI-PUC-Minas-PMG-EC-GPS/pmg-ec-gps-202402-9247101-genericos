...
| ------------------------ | ----------------------------------------------------------------- | ------- | ----- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Cliente                  | Falta de clareza nos requisitos solicitados pelo cliente          | Alto    | Alto  | Realizar workshops para levantamento de requisitos; usar protótipos para validação dos requisitos pelo cliente         | Ajustar o escopo conforme entendimento atualizado e renegociar prazos e custos com o cliente.        |
| Cliente                  | Alterações frequentes nos requisitos durante o desenvolvimento    | Médio   | Médio | Formalizar um processo de gestão de mudanças com critérios claros; comunicar impacto de alterações antes de aceitá-las | Repriorizar tarefas no backlog e reavaliar o cronograma e orçamento.                                 |
| Cronograma               | Atrasos devido a subestimação da complexidade técnica             | Alto    | Médio | Estimar o cronograma com base em estudos detalhados; incluir margem de segurança para imprevistos                      | Redistribuir tarefas entre a equipe e adicionar horas extras ou alocar recursos adicionais.          |
| Cronograma               | Dependência de entregas de fornecedores que podem atrasar         | Médio   | Médio | Acompanhar rigorosamente o cronograma de entregas dos fornecedores; estabelecer contratos com penalidades para atrasos | Substituir fornecedores atrasados ou ajustar a priorização das entregas.                             |
| Orçamento                | Aumento dos custos devido a mudanças inesperadas no escopo        | Alto    | Médio | Realizar análise detalhada de custos antes de aprovar mudanças; monitorar despesas regularmente                        | Solicitar aprovação de orçamento adicional ou reduzir escopo para ajustar ao orçamento.              |
| Tecnologia               | Dificuldade na integração de módulos do sistema                   | Alto    | Alto  | Usar padrões de desenvolvimento compatíveis; realizar testes de integração desde o início                              | Designar uma equipe dedicada para resolver falhas de integração e ajustar prazos se necessário.      |
| Tecnologia               | Problemas de desempenho com APIs externas, como geolocalização    | Médio   | Baixo | Realizar testes de carga em APIs externas antes da implementação; selecionar provedores de API com SLA garantido       | Implementar APIs alternativas ou criar soluções internas temporárias.                                |
| Equipe                   | Falta de experiência da equipe com tecnologias necessárias        | Médio   | Médio | Planejar treinamentos intensivos antes de iniciar o projeto; incluir profissionais com experiência específica no time  | Contratar consultores especializados para apoiar a equipe em momentos críticos.                      |
| Equipe                   | Rotatividade alta durante o projeto                               | Alto    | Médio | Oferecer incentivos para retenção; criar documentação detalhada para facilitar transição de conhecimento               | Repriorizar tarefas críticas e redistribuir entre os membros restantes enquanto busca substituições. |
